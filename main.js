...
$(document).ready(function () {
    ...
    $("#open-card-overlay").click(function() {
        ...
        if (openCardWindowShow) {
            ...
            var full_name = localStorage.getItem('fullname') ? localStorage.getItem('fullname') : "Petter Sandkvist";
            $("#card1-fullname,#card2-fullname").text(full_name);
            var personal_number = localStorage.getItem('PN') ? localStorage.getItem('PN'): "010312-4830";
